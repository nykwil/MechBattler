...
import {
  ...
  TRACKING_LAG_S, MOVE_JITTER_MRAD_PER_MPS, GROUND_SEARCH_CELLS, REPOSITION_HORIZON_S,
  HEAT_DISPERSION_AT_HOLD,
} from './combat.js';
...
export const SIM_VERSION = '2.19.0';
...
export function simContentHash(): string {
  ...
  cached = fnv1a(JSON.stringify({
    ...
    dials: {
      ...
      GROUND_SEARCH_CELLS, REPOSITION_HORIZON_S, HEAT_DISPERSION_AT_HOLD,
